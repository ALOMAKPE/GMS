...
?>
<!-- <a class="id1" href="#" onclick="javascript:ahah('modif_pp.php','principal');" >Modifier un professeur</a>
<a href="#" onclick="javascript:ahah('modif_matiere.php','principal');" >Modifier une mati&egrave;re</a> -->
<a href="#" onclick="javascript:ahah('chercheEleve.php','principal');" >Modifier un &eacute;l&egrave;ve</a>
<div id="principal">
</div>
